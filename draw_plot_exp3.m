clc; close all; clear;
% Load the data
load('data_exp3_h2.mat');
load('data_exp3_hinf.mat', 'hinf');
load('data_exp3_reg.mat', 'reg');
load('exp3_disturbance_energies.mat');
...
fig = figure; % Performance comparison with sinusoidal disturbances with different frequencies
