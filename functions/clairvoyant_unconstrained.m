function [Phi_x, Phi_u, obj_h2, obj_hinf] = clairvoyant_unconstrained(sys, sls, opt)
%clairvoyant_unconstrained computes the unconstrained clairvoyant 
%controller that selects the globally optimal dynamic sequence of control 
